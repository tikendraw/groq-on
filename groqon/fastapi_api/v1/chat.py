...
from ...async_api.schema import GROQ_APIRequest, AgroqServerConfig
...
agroq = AgroqServer(config=config)

@routes.post('/openai/v1/chat/completions')
...
@routes.get('/hello')
async def helloo(request):
    return web.Response(text="Hello, worlddd")