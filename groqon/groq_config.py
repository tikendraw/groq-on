...
modelindex = get_model_ids(models_file=MODEL_LIST_FILE, exclude=EXCLUDED_MODELS) if MODEL_LIST_FILE.exists() else ["gemma2-9b-it","gemma-7b-it","llama3-70b-8192","llama3-8b-8192","mixtral-8x7b-32768"]
